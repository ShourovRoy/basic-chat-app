...
/***/ "./controllers/helpers/authHelper.js":
/*!*******************************************!*\
  !*** ./controllers/helpers/authHelper.js ***!
  \*******************************************/
...
/* harmony export */   "authenticator": function() { return /* binding */ authenticator; }
/* harmony export */ });
...
const authenticator = async () => {
  try {
    // token variable
    let token; // check if token is available in cookies

    if (js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('token')) {
      token = js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get('token');
    ...
    const data = await res.json(); // validate data if any error is here
...
/* harmony import */ var _controllers_helpers_authHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/helpers/authHelper */ "./controllers/helpers/authHelper.js");
...
var _jsxFileName = "D:\\Socket.io\\chat_application\\frontend\\pages\\index.js";
...
const socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_7__.io)("http://localhost:8000");
...
const Home = ({
  ...
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false); // message input state
  ...
  const {
    0: messages,
    1: setmessages
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(serverData === null || serverData === void 0 ? void 0 : serverData.allMessages);
  const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_3__.useDispatch)();
  const router = (0,next_router__WEBPACK_IMPORTED_MODULE_5__.useRouter)(); // authenticator middleware

  const resAuth = async () => {
    const res = await (0,_controllers_helpers_authHelper__WEBPACK_IMPORTED_MODULE_2__.authenticator)();

    if (res.error) {
      // error message
      console.log(res.error); // removing token from state

      dispatch((0,_redux_reducers_authReducer__WEBPACK_IMPORTED_MODULE_4__.set_token)(null));
      return router.push('/login');
    }

    setisLoading(false);
    setIsAuthenticated(true); // authenticated message
  ...
  return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: isLoading && !isAuthenticated ? /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("h1", {
      children: "Loading"
    }, void 0, false, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("form", {
        ...
        children: messages.map((message, index) => /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("h3", {
...
/* harmony default export */ __webpack_exports__["default"] = (Home); // get serverSideProps
